...
#' fidolasen:::s2_shortname(s2_compactname_example, ext="tif")
#'
...
#' unlist(lapply(rep(s2_oldname_example,5), fidolasen:::s2_shortname, full.name=FALSE))
#'
#' \dontrun{
...
#' fidolasen:::s2_shortname(s2_existing_example, full.name=FALSE)
#' }
