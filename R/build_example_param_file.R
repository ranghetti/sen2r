  ...
  writeLines(
    jsonlite::toJSON(
      list(
        ...
        "overwrite" = FALSE,
        "path_l1c" = file.path(system.file("extdata/example_files", package = "sen2r"), "safe/L1C"),
        "path_l2a" = file.path(system.file("extdata/example_files", package = "sen2r"), "safe/L2A"),
        "path_tiles"= NA,
        "path_merged"= NA,
        "path_out" = tempdir(),
        "path_rgb" = "",
