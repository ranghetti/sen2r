...
[Installation](https://sen2r.ranghetti.info/articles/installation.html)
page.

A dockerised version of <span
style="color:#5793dd;vertical-align:top;font-size:90%;font-weight:normal;">sen</span><span
style="color:#6a7077;vertical-align:baseline;font-size:115%;font-weight:bolder;">2</span><span
style="color:#2f66d5;vertical-align:baseline;font-size:90%;font-weight:bold;">r</span>
...
container”](https://sen2r.ranghetti.info/articles/docker.html).

## Usage

The simplest way to use <span
style="color:#5793dd;vertical-align:top;font-size:90%;font-weight:normal;">sen</span><span
style="color:#6a7077;vertical-align:baseline;font-size:115%;font-weight:bolder;">2</span><span
style="color:#2f66d5;vertical-align:baseline;font-size:90%;font-weight:bold;">r</span>
is to execute it in interactive mode (see [this
vignette](https://sen2r.ranghetti.info/articles/sen2r_gui.html)):
...
Alternatively,
[`sen2r()`](https://sen2r.ranghetti.info/reference/sen2r.html) can be
launched with a list of parameters (created with
[`s2_gui()`](https://sen2r.ranghetti.info/reference/s2_gui.html)) or
passing manually the parameters as arguments of the function (see [this
vignette](https://sen2r.ranghetti.info/articles/sen2r_cmd.html) for
further details).
...
-   [`s2_list()`](https://sen2r.ranghetti.info/reference/s2_list.html)
    to retrieve the list of available Sentinel-2 products based on input
    parameters;
-   [`s2_download()`](https://sen2r.ranghetti.info/reference/s2_download.html)
    to download Sentinel-2 products;
-   [`s2_order()`](https://sen2r.ranghetti.info/reference/s2_order.html)
...
-   [`s2_rgb()`](https://sen2r.ranghetti.info/reference/s2_rgb.html) to
    ...
    raster files;
-   [`s2_calcindices()`](https://sen2r.ranghetti.info/reference/s2_calcindices.html)
...
[here](https://sen2r.ranghetti.info/articles/outstructure.html) for
details).
...
URL:
<a href="https://sen2r.ranghetti.info" target="_blank">https://sen2r.ranghetti.info</a>.
