...
For detailed instructions about using it, see the page ["Run in a Docker container"](articles/docker.md).
...
<span style="color:#5793dd;vertical-align:top;font-size:90%;font-weight:normal;">sen</span><span style="color:#6a7077;vertical-align:baseline;font-size:115%;font-weight:bolder;">2</span><span style="color:#2f66d5;vertical-align:baseline;font-size:90%;font-weight:bold;">r</span>
is to execute it in interactive mode (see [this vignette](articles/sen2r_gui.md)):
```{r, eval = FALSE}
library(sen2r)
sen2r()
```
...
(see [this vignette](articles/sen2r_cmd.md) for further details).
...
* [`s2_order()`](reference/s2_order.md)
    to order products from the Long Term Archive;
* [`sen2cor()`](reference/sen2cor.md)
...
Output products follow a specific naming convention (see [here](articles/outstructure.md) for details).
