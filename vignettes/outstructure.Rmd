...
2. [Scene Classification Map](#scene-classification-map)
...
Bands are named if an output ENVI ormat is chosen. 
...
In case the user choosed a native resolution (10, 20 or 60 m), 
...
conversely, in case the user choosed a custom resolution, the chosen resampling method is used.
...
For futher details about this product, see 
